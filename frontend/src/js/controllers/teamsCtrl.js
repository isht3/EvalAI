...
(function() {
    ...
    TeamsCtrl.$inject = ['$location', 'utilities','loaderService', '$scope', '$stateParams', '$state', '$http', '$rootScope', '$mdDialog'];

    function TeamsCtrl($location, utilities,loaderService, $scope, $stateParams, $state, $http, $rootScope, $mdDialog) {
        var vm = this;
        ...
        if ($stateParams.hash){
            vm.hash_value = $stateParams.hash;
            vm.encoding = $stateParams.encoding;
            parameters = {};
            parameters.url = 'participants/invitation/' + vm.hash_value + '/' + vm.encoding;
            parameters.method = 'POST';
            parameters.token = userKey;
            parameters.data = {};
            parameters.callback = {
